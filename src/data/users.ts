...
export const users: User[] = [
  ...
  },
  {
    ...
    courses: 1, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-05T12:00:00Z' },
  ...
  },
  {
    ...
    lastActivityAt: '2026-03-10T15:00:00Z',
    tags: ['instructor'],
    courses: 0, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-10T15:00:00Z' },
      { label: 'Manually add & enroll (instructor)', date: '2026-03-08T13:30:00Z' },
  ...
  },
  {
    ...
    role: 'User',
    registeredAt: '2026-03-14T11:45:00Z',
    lastActivityAt: '2026-03-15T10:00:00Z',
    tags: ['premium'],
    courses: 5, programs: 2, certificates: 1,
    loginActivity: [
      { label: 'Completed course', date: '2026-03-15T10:00:00Z' },
      { label: 'Logged in', date: '2026-03-14T11:45:00Z' },
    ],
  },
  {
    id: 'user-007',
    ...
    role: 'User',
    registeredAt: '2026-03-19T16:20:00Z',
    lastActivityAt: null,
    tags: ['inactive'],
    courses: 0, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-19T16:20:00Z' },
    ],
  },
  {
    id: 'user-008',
    ...
    lastActivityAt: '2026-03-25T11:00:00Z',
    tags: [],
    courses: 1, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-25T11:00:00Z' },
      { label: 'Logged in', date: '2026-03-24T12:00:00Z' },
    ],
  },
  {
    id: 'user-009',
    ...
    role: 'User',
    registeredAt: '2026-03-11T18:30:00Z',
    lastActivityAt: '2026-03-12T11:00:00Z',
    tags: [],
    courses: 2, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-12T11:00:00Z' },
      { label: 'Enrolled in course', date: '2026-03-11T18:35:00Z' },
      { label: 'Logged in', date: '2026-03-11T18:30:00Z' },
    ],
  },
  {
    id: 'user-010',
    ...
    role: 'User',
    registeredAt: '2026-03-21T11:10:00Z',
    lastActivityAt: '2026-03-22T09:30:00Z',
    tags: ['engaged'],
    courses: 4, programs: 1, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-22T09:30:00Z' },
      { label: 'Drip feed section unlocked', date: '2026-03-21T12:00:00Z' },
      { label: 'Logged in', date: '2026-03-21T11:10:00Z' },
    ],
  },
  {
    id: 'user-011',
    ...
    role: 'User',
    registeredAt: '2026-03-28T13:00:00Z',
    lastActivityAt: '2026-03-29T16:00:00Z',
    tags: ['onboarding', 'premium'],
    courses: 2, programs: 0, certificates: 1,
    loginActivity: [
      { label: 'Logged in', date: '2026-03-29T16:00:00Z' },
      { label: 'Completed course', date: '2026-03-29T15:45:00Z' },
      { label: 'Logged in', date: '2026-03-28T13:00:00Z' },
    ],
  },
  {
    id: 'user-012',
    ...
    role: 'User',
    registeredAt: '2026-04-01T12:45:00Z',
    lastActivityAt: '2026-04-02T11:00:00Z',
    tags: ['engaged'],
    courses: 3, programs: 1, certificates: 0,
    loginActivity: [
      { label: 'Drip feed section unlocked', date: '2026-04-02T11:00:00Z' },
      { label: 'Logged in', date: '2026-04-01T12:45:00Z' },
    ],
  },
  {
    id: 'user-013',
    ...
    role: 'User',
    registeredAt: '2026-04-05T18:10:00Z',
    lastActivityAt: '2026-04-05T18:15:00Z',
    tags: ['onboarding'],
    courses: 2, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-04-05T18:15:00Z' },
      { label: 'Enrolled in course', date: '2026-04-05T18:12:00Z' },
      { label: 'Logged in', date: '2026-04-05T18:10:00Z' },
    ],
  },
  {
    id: 'user-014',
    ...
    role: 'User',
    registeredAt: '2026-04-08T14:30:00Z',
    lastActivityAt: '2026-04-08T14:31:00Z',
    tags: ['onboarding', 'active'],
    courses: 1, programs: 0, certificates: 0,
    loginActivity: [
      { label: 'Logged in', date: '2026-04-08T14:30:00Z' },
      { label: 'Is an imported new user', date: '2026-04-08T14:29:00Z' },
    ],
  },
]
