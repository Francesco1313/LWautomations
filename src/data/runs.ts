...
export const runs: Run[] = [
  ...
  // Delay variant runs — Option B prototype
  {
    ...
    automationId: 'auto-001',
    userId: 'user-005',
    userName: 'Chiara Russo',
    userEmail: 'chiara.russo@example.com',
    ...
    steps: [
      ...
      { type: 'delay', label: 'Delay', outcome: 'success', errorMessage: null, timestamp: '2026-04-20T09:01:00Z', delayVariant: 'wait_until_specific_moment', waitingPrefix: 'Currently waiting until', waitingChips: ['20 Oct 2025', '01:15 pm'], isCurrentStep: true, canAdvance: true, advancedManually: false },
    ],
  },
  {
    id: 'run-d02',
    ...
    status: 'in_progress',
    steps: [
      { type: 'trigger', label: 'User signs up', outcome: 'success', errorMessage: null, timestamp: '2026-04-21T10:00:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-04-21T10:00:10Z' },
      { type: 'delay', label: 'Delay', outcome: 'success', errorMessage: null, timestamp: '2026-04-21T10:01:00Z', delayVariant: 'wait_until_time_of_day', waitingPrefix: 'Currently waiting until the next', waitingChips: ['01:15 pm'], isCurrentStep: true, canAdvance: true, advancedManually: false },
    ],
  },
  {
    id: 'run-d03',
    ...
    status: 'in_progress',
    steps: [
      { type: 'trigger', label: 'User signs up', outcome: 'success', errorMessage: null, timestamp: '2026-04-22T08:30:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-04-22T08:30:10Z' },
      { type: 'delay', label: 'Delay', outcome: 'success', errorMessage: null, timestamp: '2026-04-22T08:31:00Z', delayVariant: 'wait_until_day_of_week', waitingPrefix: 'Currently waiting until', waitingChips: ['Monday', '01:15 pm'], isCurrentStep: true, canAdvance: true, advancedManually: false },
    ],
  },
  {
    id: 'run-d04',
    ...
    status: 'in_progress',
    steps: [
      { type: 'trigger', label: 'User signs up', outcome: 'success', errorMessage: null, timestamp: '2026-04-23T11:00:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-04-23T11:00:10Z' },
      { type: 'delay', label: 'Delay', outcome: 'success', errorMessage: null, timestamp: '2026-04-23T11:01:00Z', delayVariant: 'wait_for_duration_from_field', waitingPrefix: 'Currently waiting for', waitingChips: ['Birthday date'], isCurrentStep: true, canAdvance: true, advancedManually: false },
    ],
  },
  {
    id: 'run-d05',
    ...
    userEmail: 'paolo.russo@example.com',
    ...
    steps: [
      ...
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-04-24T14:00:10Z' },
      { type: 'delay', label: 'Delay', outcome: 'success', errorMessage: null, timestamp: '2026-04-24T14:01:00Z', delayVariant: 'wait_until_moment_from_field', waitingPrefix: 'Currently waiting until', waitingChips: ['Trial end date'], isCurrentStep: true, canAdvance: true, advancedManually: false },
    ],
  },
]
