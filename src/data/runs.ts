...
export const runs: Run[] = [
  ...
  },
  {
    ...
    userName: 'Martina Ricci',
    userEmail: 'martina.ricci@example.com',
    enrolledAt: '2026-03-19T15:20:00Z',
    triggerEvent: 'Admin manually enrolls user',
    reentryRule: 'Once per user',
    status: 'completed',
    steps: [
      { type: 'trigger', label: 'Admin manually enrolls user', outcome: 'success', errorMessage: null, timestamp: '2026-03-19T15:20:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-03-19T15:21:00Z' },
      { type: 'action', label: 'Add to newsletter tag', outcome: 'success', errorMessage: null, timestamp: '2026-03-19T15:21:05Z' },
      { type: 'branch', label: 'Branch', outcome: 'success', branchPath: 'yes', errorMessage: null, timestamp: '2026-03-19T15:21:08Z' },
      { type: 'completion', label: 'Automation completed', outcome: 'success', errorMessage: null, timestamp: '2026-03-19T15:21:10Z' },
    ],
  },
  {
    id: 'run-024',
    ...
    userName: 'Paolo Conti',
    userEmail: 'paolo.conti@example.com',
    enrolledAt: '2026-03-26T09:00:00Z',
    triggerEvent: 'Admin manually enrolls user',
    reentryRule: 'Once per user',
    status: 'completed',
    steps: [
      { type: 'trigger', label: 'Admin manually enrolls user', outcome: 'success', errorMessage: null, timestamp: '2026-03-26T09:00:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'success', errorMessage: null, timestamp: '2026-03-26T09:00:30Z' },
      { type: 'action', label: 'Add to newsletter tag', outcome: 'success', errorMessage: null, timestamp: '2026-03-26T09:00:35Z' },
      { type: 'branch', label: 'Branch', outcome: 'success', branchPath: 'no', errorMessage: null, timestamp: '2026-03-26T09:00:38Z' },
      { type: 'completion', label: 'Automation completed', outcome: 'success', errorMessage: null, timestamp: '2026-03-26T09:00:40Z' },
    ],
  },
  {
    id: 'run-025',
    ...
    userName: 'Roberto Mancini',
    userEmail: 'roberto.mancini@example.com',
    enrolledAt: '2026-04-02T11:00:00Z',
    triggerEvent: 'Admin manually enrolls user',
    reentryRule: 'Once per user',
    status: 'failed',
    steps: [
      { type: 'trigger', label: 'Admin manually enrolls user', outcome: 'success', errorMessage: null, timestamp: '2026-04-02T11:00:00Z' },
      { type: 'action', label: 'Send welcome email', outcome: 'failed', errorMessage: 'SMTP connection timeout. The mail server did not respond within the expected time.', timestamp: '2026-04-02T11:00:30Z' },
    ],
  },
]
