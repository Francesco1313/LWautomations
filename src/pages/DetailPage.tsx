...
import AutomationLogsTab, { StatusFilter } from '../components/detail/AutomationLogsTab'
      ...
      <main style={{
        ...
        <div style={{ flex: 1, padding: '24px 32px' }}>
          ...
          {activeTab === 'performance' && (
            <PerformanceTab
              runs={automationRuns}
              onMetricClick={filter => { setStatusFilter(filter); setActiveTab('automation-logs') }}
            />
          )}
